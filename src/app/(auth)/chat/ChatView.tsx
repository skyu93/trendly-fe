...
//   { id: 1, isMine: false, text: '안녕하세요! 😊', reactions: [{emoji: '😊', count: 2}], replies: 1, nickname: '김철수' },
//   { id: 2, isMine: true, text: '네, 안녕하세요. 오늘 어떻게 지내세요?', reactions: [], replies: 0 },
//   { id: 3, isMine: false, text: '잘 지내고 있어요. 프로젝트는 어떻게 진행되고 있나요? 🤔', reactions: [{emoji: '😊', count: 1}], replies: 2, nickname: '김철수' },
//   { id: 4, isMine: true, text: '거의 완료 단계에 있어요. 이번 주말까지 마무리할 예정입니다. 🎉', reactions: [{emoji: '😊', count: 3}], replies: 1 },
// ];
//
...
//           <ArrowLeft className="w-4 h-4 mr-3 text-greyscale-40" />
...
//         {showScrollButton && (
//           <button
//             className={isSafari ? "fixed bottom-24 right-4 bg-blue-500 text-white rounded-full p-2 shadow-lg hover:bg-blue-600 transition-all z-10" :
